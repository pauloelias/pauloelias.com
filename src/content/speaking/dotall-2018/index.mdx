...
description: "In this talk I discuss how to use Craft CMS as a headless cms to power your next React-based single page app. We cover how React, GraphQL, and Apollo work with eachother and then run through lots of example code to piece it all together."
